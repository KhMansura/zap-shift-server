...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.shyhiog.mongodb.net/?appName=Cluster0`;
...
async function run() {
  ...
  app.patch('/payment-success', async(req, res) =>{
    ...
    const query = {transactionId: trackingId}
